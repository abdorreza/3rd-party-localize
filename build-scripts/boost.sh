...
downloadBoost()
{
	...
	echo http://sourceforge.net/projects/boost/files/boost/boost_$BOOST_VERSION_SFX.tar.bz2/download
##curl -L -o $BOOST_TARBALL http://sourceforge.net/projects/boost/files/boost/$VERSION/$BOOST_TARBALL/download
curl -L -o $BOOST_TARBALL http://sourceforge.net/projects/boost/files/boost/$BOOST_VERSION/boost_$BOOST_VERSION_SFX.tar.bz2/download
    fi
    doneSection
}
