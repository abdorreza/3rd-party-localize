...
# Install gmock
cp "$LIB_LOCATION/lib/libceres.a" "$LIB_INSTALL_LOCATION"
cp "$LIB_LOCATION/config/ceres/internal/config.h" "$PLATFORM_HEADER_INSTALL_LOCATION"
cp -R "$PROJECT_LOCATION/include/ceres" "$HEADER_INSTALL_LOCATION"
