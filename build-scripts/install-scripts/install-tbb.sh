...
# Install gmock
cp $LIB_LOCATION/libs/*/libtbb.a "$LIB_INSTALL_LOCATION"
cp -R "$PROJECT_LOCATION/include/serial" "$HEADER_INSTALL_LOCATION/"
cp -R "$PROJECT_LOCATION/include/tbb" "$HEADER_INSTALL_LOCATION/"
