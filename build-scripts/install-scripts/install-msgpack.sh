...
# Install gmock
cp $LIB_LOCATION/libs/*/libmsgpack.a "$LIB_INSTALL_LOCATION"
cp -R "$PROJECT_LOCATION/src/msgpack" "$HEADER_INSTALL_LOCATION/"
cp "$LIB_LOCATION/src/msgpack/version.h" "$HEADER_INSTALL_LOCATION/msgpack/"
