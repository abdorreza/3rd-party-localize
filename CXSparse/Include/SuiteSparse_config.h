...
// Adjusted by Andriy Grygorenko according to a documentation
// Documentation stated that SuiteSparse expectes that long int is 64bit
// so we choose cross platform solution for it
#include <stdint.h>
