...
# build$ cmake .. -DCMAKE_TOOLCHAIN_FILE=cmake/toolchain/linux-gcc.toolchain.cmake
...
set( CMAKE_C_COMPILER           "${CLANG_INSTALL_ROOT}/bin/gcc" )
set( CMAKE_CXX_COMPILER         "${CLANG_INSTALL_ROOT}/bin/g++" )
...
include ("${TOOLCHAIN_CONFIG_DIR}/linux-gcc-config.cmake")
